package com.prata.notificacao.business;

import com.prata.notificacao.business.dto.TarefasDTO;
import com.prata.notificacao.infrastructure.exceptions.EmailException;
...
public class EmailService {
    ...
    public void enviaEmail(TarefasDTO dto){
        try {
            ...
            mimeMessageHelper.setSubject("Notificação Tarefa");
